...
function main() {
	...
	var testAt2 = Vector.subtract(new Vector(2,-2,9),testEye);
    var view = {eye:testEye, at:testAt, up:new Vector(0,1,0)};
	var view1 = {eye:testEye, at:testAt, up:new Vector(1,1,0)};
    ...
    var poly1 = [{x:-5,y:5,z:10,c:new Color(0,0,0,255)}, {x:5,y:5,z:10,c:new Color(0,255,0,255)}, 
                 {x:5,y:-5,z:10,c:new Color(255,0,0,255)},{x:-5,y:-5,z:10,c:new Color(0,0,255,255)}];
    ...
    //pic 1
    //projectPoly(imagedata,poly1,view1);
    //fillPoly(imagedata,poly1);
    //pic 2
    projectPoly(imagedata,poly,view2);
    fillPoly(imagedata,poly);
